  ...
  const metrics = [
    {
      ...
      href: 'http://localhost:3000/d/rps',
      icon: '📊',
      color: '#10B981',
    },
    {
      ...
      href: 'http://localhost:3000/d/latency',
      icon: '⚡',
      color: '#3B82F6',
    },
    {
      ...
      href: 'http://localhost:3000/d/elastic',
      icon: '🔍',
      color: '#F59E0B',
    },
    {
      ...
      href: 'http://localhost:3000/d/postgres',
      icon: '🗄️',
      color: '#8B5CF6',
    },
    {
      ...
      href: 'http://localhost:3000/d/errors',
      icon: '⚠️',
      color: '#EF4444',
    },
  ];
